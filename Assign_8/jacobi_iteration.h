...
void compute_on_device_naive(const matrix_t, matrix_t, const matrix_t, int num_elements);
void compute_on_device_opt(const matrix_t, matrix_t, const matrix_t, int num_elements);
